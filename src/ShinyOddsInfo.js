...
class ShinyOddsInfo extends React.Component {
  getShinyChanceLabel(generation, strategy, options, streak) {
    const chance = ShinyOddsUtils.getShinyChance(generation, strategy, options, streak)
  ...
  render() {
    const shinyChanceLabel = this.getShinyChanceLabel(this.props.generation, this.props.strategy, this.props.options, this.props.count)
